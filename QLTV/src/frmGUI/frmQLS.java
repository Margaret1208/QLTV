...
public class frmQLS extends javax.swing.JFrame {
    ...
    public frmQLS() {
        ...
        showData(DbConnect.helper.GET(defaultSQLStatement)); 
    } 
    // viet ham xoa Text
    ...
    public void InsertData() throws SQLException {
        ...
        int isInsert = DbConnect.helper.INSERT(Operation.INSERTSQLSach,stringsSQL,5);
        if (isInsert > 0 ){
    ...
    public void UpdateData() throws SQLException {
        ...
        int isUpdate = DbConnect.helper.UPDATE(Operation.UPDATESQLSach, stringsSQL, 5);
        if (isUpdate > 0 ){
    ...
    public void DeleteData() throws SQLException {
        int isDelete = DbConnect.helper.DELETE(Operation.DELETESQLSach,txtMaSach.getText().toString());
        if (isDelete > 0 ){
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        // TODO add your handling code here:
        // Them cái ấn Enter thì tự nhận vào cho tiện. Toàn hải dùng chuột ấn search hơi biêng
