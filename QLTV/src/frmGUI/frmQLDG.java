...
public class frmQLDG extends javax.swing.JFrame {
    ...
    public void InsertData () throws SQLException {        
        ...
        int isInsert = DbConnect.helper.INSERT(Operation.INSERTSQLDocGia, stringsSQL, 4);
        if (isInsert > 0 ){
    ...
    public void UpdateData() throws SQLException{
        ...
        int isUpdate = DbConnect.helper.UPDATE(Operation.UPDATESQLDocGia, stringsSQL, 4);
        if (isUpdate > 0 ){
    ...
    public void DeleteData(){
        int isDelete = DbConnect.helper.DELETE(Operation.DELETESQLDocGia, txtMaDG.getText().toString());
        if (isDelete > 0 ){
