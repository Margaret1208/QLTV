...
// viet ham xoa Text
    ...
    public void InsertData() throws SQLException{
        ...
        int isInsert = DbConnect.helper.INSERT(Operation.INSERTSQLPM,stringsSQL,3);
        if (isInsert > 0 ){
    ...
    public void UpdateData() throws SQLException {
        ...
        int isUpdate = DbConnect.helper.UPDATE(Operation.UPDATESQLPM,stringsSQL,3);
        if (isUpdate > 0 ){
    ...
    public void DeleteData() {
        ...
        int isDelete = DbConnect.helper.DELETE(Operation.DELETESQLPM,txtMaPM.getText().toString());
        if (isDelete > 0 ){
